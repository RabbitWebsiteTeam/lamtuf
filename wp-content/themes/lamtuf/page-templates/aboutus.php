...
<p>Lamtuf started its operation in the year 1976 as a small moulder. Over the years, we developed our team and technology to become a Global Leader in Phenolic Fabric and Paper Industrial laminates.</p>

<p>Lamtuf is a fully integrated plant with its own resin making, impregnating, pressing and machining facilities. It has a well equipped Laboratory and R&D division. We are proud of our team who in the year 2010 successfully introduced Phenolic film for shuttering boards used by construction industry. Again in the year 2012, the team developed Densified wood laminates and today we are a leading manufacturer of it. After working few years on the chemistry and process to manufacture Epoxy Glass laminates and we launched the product, meeting stringent specifications, in the year, 2015. </p>

<p>Lamtuf is located at Hyderabad, India.</p>
 ...
 <div class="container">
	<div class="row ">
            ...
            <div class="col-md-4 col-xs-12 bhoechie-tab-menu1 nopad">
			 <div class="list-group-item text-center product-head">Get To <br/>Know Us</div>
            ...
            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 bhoechie-tab">
                ...
                <div class="bhoechie-tab-content active">
                  <div class="text-center title-head">TEAM</div>
...
These materials find numerous usages in mechanical applications like gears, pulleys, guides etc. and as bearing materials. These are also used where electrical insulation is required with structural / mechanical strengths.</p>
				...
				<div class="img"><img src="<?php bloginfo('template_url'); ?>/assets/images/dummy.jpg"></div>
				<div class="head">Person Name</div>
				<div class="desg">Desgination</div>
				</div>
				</div>
				<div class="col-md-4 col-sm-6 col-xs-12 ">
				<div class="s2-box-border1">
...
<section>   
	        <div class="container">
 <div class="row">
		    <div class="col-md-4 col-xs-12 block-left1">
		   <div class="left-txt1">
		   EnQuire<br/>Now
		   </div>
		 </div>
	          <div class="col-md-8 col-xs-12 form-book">
