<div class="asfbFilterCol asfbCheckbox <?php echo $this->get('class'); ?>">
    ...
    <?php if ( $this->hasOptions() ) : ?>
        <span class="asfbWrapInput">
			<?php foreach ($this->getOptions() as $key => $value) : ?>
                <?php $uniqId = implode('_', array('checkbox', $this->get('type'), $this->getName(), $value['value'])); ?>

                <label for="<?php echo $uniqId ?>"
                       class="checkboxCustomStyle <?php echo $this->get('class'); ?>">
                    <input
